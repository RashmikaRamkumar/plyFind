  ...
  return (
    <div className="p-8">
      ...
      <div className="flex space-x-4 mb-6">
        <button 
          className={`px-4 py-2 rounded ${activeTab === 'enquiries' ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
                ...
                {enquiries.map((enq) => (
                  <tr key={enq._id} className="border-t">
                    ...
                    <td className="px-4 py-2">
                      <span className={`px-2 py-1 rounded-full text-sm ${getStatusBadgeColor(enq.status)}`}>
                        {enq.status}
                      </span>
                    </td>
