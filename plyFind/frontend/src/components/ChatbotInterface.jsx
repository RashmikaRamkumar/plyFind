    ...
    <>
      {!visible && (
        <button
          ...
          className="fixed right-6 p-4 rounded-full bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-500 hover:to-gray-600 z-50"
          style={{ bottom: "90px" }}
        >
              ...
              <div className="text-white text-center mt-10 p-4 bg-gray-800 bg-opacity-60 rounded-lg">
                {isTamil
                  ? // ? "வணக்கம்! கச்சேரி டிக்கெட் புக்கிங் குறித்து என்னிடம் கேளுங்கள்."
                    ...
                    "வணக்கம்! ரகேஷ் கிளாஸ் மற்றும் பிளாய்வுட் சேவைகளுக்கு உங்களை வரவேற்கின்றேன். நான் எவ்வாறு உதவ முடியும்?"
                  : "Hello! Welcome to Rakesh Glass and Plywood. How can I assist you today?"}
              </div>
            )}
            ...
            >
              ...
              <div className="flex space-x-2 mt-2">
                <button
                  ...
                  className="px-2 h-10 flex items-center gap-1 rounded-lg bg-[#3f3f46] text-[#d4d4d8] shadow-lg"
                  title="English"
                >
                  Eng <FontAwesomeIcon icon={faMicrophone} />
                </button>
                ...
                <button
                  ...
                  title="தமிழ்"
                >
                  தமிழ் <FontAwesomeIcon icon={faMicrophone} />
                </button>
